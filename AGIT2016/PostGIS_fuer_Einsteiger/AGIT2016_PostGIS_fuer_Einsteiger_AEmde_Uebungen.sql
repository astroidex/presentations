...
-- AGIT 2016 Astrid Emde

-- Es werden die Daten der OSGeo-Live verwendet
-- /home/user/data/natural_erath2/
...
Select 1, st_union(geom)::geometry(multipolygon,4326) as geom from laender where admin = 'Austria';

Create view brd as 
Select 1, st_union(geom)::geometry(multipolygon,4326) as geom from laender where admin = 'Germany';
